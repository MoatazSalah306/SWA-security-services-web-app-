<header class="text-gray-400 bg-gray-900 body-font px-5 shadow-lg">
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    <nav class="flex lg:w-2/5 flex-wrap items-center text-base md:ml-auto">
        <a class="mr-5 text-[#4299E1] hover:text-white">Home</a>
        <a class="mr-5 hover:text-white">Services</a>
        <a class="mr-5 hover:text-white">Feedback</a>
        <a class="hover:text-white">Pricing</a>
    </nav>
    <a class="flex order-first lg:order-none lg:w-1/5 title-font font-medium items-center text-white lg:items-center lg:justify-center mb-4 md:mb-0">
        ...
        <span class="ml-3 text-xl xl:block lg:hidden">SWA</span>
    </a>
